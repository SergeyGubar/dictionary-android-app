...
public class ColorsActivity extends AppCompatActivity {
    ...
    private final String TAG = "ColorsActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DatabaseReference mDataBase = FirebaseDatabase.getInstance().getReference().child("Words").child("Colors");


        floatButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ColorsActivity.this, AddActivity.class);
        ...
        mDataBase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                WordAdapter adapter = new WordAdapter(ColorsActivity.this, listOfWords);
